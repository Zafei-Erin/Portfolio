...
export const TechStack = () => {
  return (
    <div className="min-h-40 mb-20 flex max-md:flex-col md:items-start md:justify-evenly gap-10 px-36 p-5 lg:p-10">
      <motion.div
      ...
      <motion.div
        ...
        className="flex gap-6 lg:gap-5 w-full md:w-fit items-center justify-center"
      >
